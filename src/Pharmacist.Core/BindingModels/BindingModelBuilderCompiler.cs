...
{
    internal sealed class BindingModelBuilderCompiler : ICompilation, IDisposable
    {
        ...
        public BindingModelBuilderCompiler(InputAssembliesGroup input, NuGetFramework framework)
        {
